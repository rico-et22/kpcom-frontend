  ...
  return (
    <div id="site-root">
      <Head>
        ...
        <meta
          property="og:title"
          content="About me • Kamil Pawlak - front-end web developer"
        />
      </Head>
      <Navbar
      ...
      />
      <AboutHeader
        location={props.aboutLocationInfo}
        social={props.aboutSocialLinks}
        emails={props.emails}
        resumeLinks={props.resumeLinks}
      />
      <main>
...
export async function getStaticProps() {
  ...
  return {
    props: {
      ...
      aboutLocationInfo:
        apolloClient.cache.extract().ROOT_QUERY.aboutPageLocationInfoCollection
          .items,
      aboutSocialLinks:
        apolloClient.cache.extract().ROOT_QUERY.aboutPageSocialLinkCollection
          .items,
      aboutInfoText:
