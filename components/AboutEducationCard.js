export default function AboutEducationCard(props) {
  return (
    <div className='about-info-card'>
      <div className='about-info-card-left'>
        {props.image ? <img src={props.image.url} className='about-info-card-image' alt={`Logo of ${props.schoolName}`}/> : ''}
      </div>
      <div className='about-info-card-right'>
        <div className='about-info-card-header-group'>
          {props.image ? <img src={props.image.url} className='about-info-card-image-mobile' alt={`Logo of ${props.schoolName}`}/> : ''}
          <div className='about-info-card-headers'>
            <h2>{props.schoolName}</h2>
            <h3>{props.degreeInfo}</h3>
          </div>
        </div>
