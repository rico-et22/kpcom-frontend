      ...
      <div className='portfolio-item-info'>
        ...
        <div className='portfolio-item-down'>
          <div className='portfolio-item-buttons-container'>
            <a href={previewLink} className='portfolio-item-button link' target='_blank' rel='noopener'>See it live</a>
            {repoLink && <a href={repoLink} className='portfolio-item-button link github' target='_blank' rel='noopener'>GitHub repo</a>}
          </div>
        </div>
      </div>
    </div>
