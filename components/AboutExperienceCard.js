  ...
  return (
    <div className='about-info-card'>
      <div className='about-info-card-left'>
        {props.image ? <img src={props.image.url} className='about-info-card-image'  alt={`Logo of ${props.companyName}`}/> : ''}
      </div>
      <div className='about-info-card-right'>
        <div className='about-info-card-header-group'>
          {props.image ? <img src={props.image.url} className='about-info-card-image-mobile' alt={`Logo of ${props.companyName}`}/> : ''}
        ...
        <p className='about-info-card-description' dangerouslySetInnerHTML={{__html:props.description}}/>
      </div>
    </div>
  )
}
